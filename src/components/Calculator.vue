<template>
  <div id="calculator" class="calculator-wrapper">
    <div class="calculator">
      <div class="calculator-left">
        ...
        <div class="calculator-flow">
          <div>
            <div class="calculator-field__title">
              Выберите марку авто, которую хотите приобрести
            </div>
            <el-select
      ...
      <div class="calculator-right">
        <div class="calculator-right__card">
          ...
          <a href="" class="button" @click.prevent="togglePopup()">
            Получить онлайн одобрение
          </a>
    ...
    <form-popup :is-popup-open="isPopupOpen" :inner-visible="innerVisible">
      <modal-inner @setScorringStatus="setScorringStatus" />
    </form-popup>
  </div>
</template>
...
.calculator {
  ...
  &-right {
    ...
    &__card {
      ...
      padding-top: 48px;
      margin-top: 75px;
      box-shadow: 0px 2px 10px rgba(41, 42, 46, 0.05),
        0px 15px 40px rgba(29, 42, 69, 0.08);
      border-radius: 10px;
      width: 100%;
