    ...
    <div class="dialog-wrapper-div">
      <div class="form">
        ...
        <div class="custom-acception">
          <el-checkbox v-model="accept" class="custom-acception">
            <div class="text">
        ...
        <el-button type="text" class="close is-no-stroke" @click="hide">
...
.popup {
  ...
  .form {
    ...
    .custom-button:disabled {
      background-color: rgba(207, 215, 232, 0.2);
      border-color: rgba(207, 215, 232, 0.2);
    }
